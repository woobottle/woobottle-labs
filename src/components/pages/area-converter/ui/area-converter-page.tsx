          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-blue-50/50 rounded-xl p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-800">평(坪)</h3>
              </div>
            ...
            <div className="bg-green-50/50 rounded-xl p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-800">제곱미터(㎡)</h3>
              </div>
              <p className="text-gray-700 leading-relaxed">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/30 p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <h3 className="font-semibold text-gray-800 mb-2">실시간 변환</h3>
              <p className="text-sm text-gray-600">입력과 동시에 즉시 변환</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-3">
                <span className="text-2xl">🎯</span>
              </div>
              <h3 className="font-semibold text-gray-800 mb-2">정확한 계수</h3>
              <p className="text-sm text-gray-600">법정 변환 계수 사용</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-3">
                <span className="text-2xl">🏠</span>
              </div>
              <h3 className="font-semibold text-gray-800 mb-2">빠른 선택</h3>
              <p className="text-sm text-gray-600">일반적인 평수 프리셋</p>
            </div>
            <div className="text-center">
