    ...
    return (
      <div key={item.id} className="relative">
        <Link
          ...
          className={`
            relative w-full flex items-center gap-3 px-3 py-2.5 pr-10 rounded-lg
        ...
        <button
          ...
          className="absolute right-2 top-1/2 -translate-y-1/2 flex h-7 w-7 items-center justify-center rounded-md hover:bg-[#1A1A1A]"
      ...
      >
        ...
        <div className="flex-shrink-0 border-t border-[#1A1A1A]">
          <div className="px-4 py-4 text-center text-xs text-[#525252]">
            <p>v1.0.0</p>
            <p className="mt-1">© {new Date().getFullYear()} WooBottle Labs</p>
          </div>
        </div>
      </div>
    </>
